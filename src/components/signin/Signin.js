                    ...
                    <div className="measure center">
                        ...
                        <div className="lh-copy mt3 tc">
                            <input className="white-input b ph4 pv2 input-reset ba br3  b--black bg-transparent grow pointer f4 dib"
                                   type="submit" value="Sign in" onClick={this.onSubmitPressed} />
                        </div>
                        <div className="lh-copy mt3 tc">
                            <p onClick={() => onRouteChange('register')} className="white pointer f4 center link dim black db self-center  ">- - Register - -</p>
                        </div>
                    </div>
                </main>
            </article>
